...
product = rasterio.open(r'E:\China Forest Region Experiment\Dataset\NDVI\High/t1fine3.TIF')
profile = product.profile
LandsatT0 = rasterio.open(r'E:\China Forest Region Experiment\Dataset\NDVI\High/t1fine3.TIF').read(1)
MODISt0 = rasterio.open(r'E:\China Forest Region Experiment\Dataset\NDVI\High/t1coarse3.TIF').read(1)
MODISt1 = rasterio.open(r'E:\China Forest Region Experiment\Dataset\NDVI\Low\20200628-30\20200628-30_mosic3.TIF').read(1)
...
file_name = path + '20200628-30-3prediction.tif'
